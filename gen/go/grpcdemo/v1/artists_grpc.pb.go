...
const (
	ArtistService_CreateArtist_FullMethodName = "/grpcdemo.v1.ArtistService/CreateArtist"
	ArtistService_GetArtists_FullMethodName   = "/grpcdemo.v1.ArtistService/GetArtists"
	ArtistService_UpdateArtist_FullMethodName = "/grpcdemo.v1.ArtistService/UpdateArtist"
	ArtistService_DeleteArtist_FullMethodName = "/grpcdemo.v1.ArtistService/DeleteArtist"
	ArtistService_ListArtists_FullMethodName  = "/grpcdemo.v1.ArtistService/ListArtists"
)
...
var ArtistService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpcdemo.v1.ArtistService",
	...
	Metadata: "grpcdemo/v1/artists.proto",
}
